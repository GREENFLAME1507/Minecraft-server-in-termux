   ![mst](https://github.com/GREENFLAME1507/Minecraft-server-in-termux/assets/160883635/9cef49b8-973f-4a15-becf-4fe174df5615)
 # ![mst](https://github.com/GREENFLAME1507/Minecraft-server-in-termux/assets/160883635/9cef49b8-973f-4a15-becf-4fe174df5615)MINECRAFT SERVER IN TERMUX  
...
## Support
- As this project dosen't use specific aarch64 links this can be used in any linux distros which are deb based

## Installation
To start type the following the terminal
```
apt update
apt upgrade -y
```
